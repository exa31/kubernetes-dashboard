...
function initTerminal() {
  ...
  term = new Terminal({
    ...
    fontSize: 13,
    fontFamily:
      '"Fira Code", "JetBrains Mono", Consolas, "Liberation Mono", Menlo, Courier, monospace',
    theme: {
      background: '#090d16',
      foreground: '#e2e8f0',
      cursor: '#10b981',
  ...
  >
    ...
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <div
          v-if="props.containers.length > 1"
        ...
        >
          <i
            :class="isFullscreen ? 'pi pi-window-minimize' : 'pi pi-window-maximize'"
            class="text-xs"
          ></i>
        </button>
    ...
    >
      <div class="flex items-center gap-4">
        <span
          >Press
          <kbd
            class="px-1.5 py-0.5 rounded bg-slate-800 text-slate-300 border border-slate-700 text-[10px]"
            >Ctrl+C</kbd
          >
          to interrupt</span
        >
